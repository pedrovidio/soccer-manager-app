...
export const styles = StyleSheet.create({
  ...
  readOnlyBadge: {
    backgroundColor: Arena.warningBg,
    borderRadius: Radius.r8,
    paddingHorizontal: 8,
    paddingVertical: 4,
  },
  readOnlyText: { fontSize: 11, fontWeight: '600', color: Arena.warning },
  ...
  btnText: { color: Arena.buttonLabelPrimary, fontSize: 15, fontWeight: '900' },
});
