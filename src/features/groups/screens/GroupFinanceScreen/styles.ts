...
export const styles = StyleSheet.create({
  ...
  actionPaid: { backgroundColor: Colors.successLight, borderColor: Colors.successLight },
  actionPaidText: { fontSize: 12, fontWeight: '800', color: Colors.successDark },
  ...
  paidBadgeText: { color: Colors.successDark, fontSize: 11, fontWeight: '800' },
