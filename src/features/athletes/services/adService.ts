...
export const adService = {
  ...
  showRewardedAd: async ({ onEarnReward, onAdClose, onError }: ShowRewardedAdParams): Promise<{ isSimulated: boolean }> => {
    appLogger.info('[AdService] Inicializando carregamento de anúncio premiado.');
    ...
    try {
      ...
      appLogger.info('[AdService] Ambiente Expo Go detectado. Utilizando simulador visual.');
